...
public class DrivingData {
	...
	public double getDistanceKm(double xNewPosition, double yNewPosition) {
        // Distância euclidiana entre as posições atual e nova
        double distancia = Math.sqrt(Math.pow(xNewPosition - this.x_Position, 2) + Math.pow(yNewPosition - this.y_Position, 2));
        
        // Convertendo a distância para quilômetros (considerando metros)
        distancia = distancia / 1000.0; // Supondo que as posições estejam em metros, convertendo para quilômetros
        return distancia;
    }
